...
In "Webcam-Based Eye Movement Analysis Using CNN"\cite{webcam_based_cnn}, the authors Meng
...
There are some other non-CNN based experiments based on a paper by Fabian Timm - "Accurate Eye center localization by means of Gradient"{fabian}. 
